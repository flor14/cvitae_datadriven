...
Cursos de postgrado y certificaciones {data-icon=suitcase}
--------------------------------------------------------------------------------
...
```{r}
CV %<>% print_section('publicaciones')
```
...
Comunidades  {data-icon=newspaper}
--------------------------------------------------------------------------------
...
Formación de Recursos Humanos {data-icon=book}
--------------------------------------------------------------------------------
...
Otros Antecedentes {data-icon=book}
--------------------------------------------------------------------------------
